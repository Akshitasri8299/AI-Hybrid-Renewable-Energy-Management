...
class Command(BaseCommand):
    help = "Seeds the database with 7 days of sample hourly energy data"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("Generating 7 days of hourly data...")
        ...
        for hours_ago in range(7 * 24, 0, -1):
            ...
            # Forecast made 1 hour before target_time, predicting this hour
        ...
        self.stdout.write(self.style.SUCCESS("Done! Created:"))
