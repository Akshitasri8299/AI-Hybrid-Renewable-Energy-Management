            ...
            {!loading && hasComparisonData && (
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={data.comparison}>
                  ...
                  <Line type="monotone" dataKey="predicted_wind" stroke="#38bdf8" name="Predicted Wind (kW)" />
                  <Line type="monotone" dataKey="actual_wind" stroke="#7dd3fc" strokeDasharray="4 2" name="Actual Wind (kW)" />
